...
class SequenceGenerator(object):
    def __init__(
        ...
        self.bos = tgt_dict.bos() # adjust accoriding to https://github.com/pytorch/fairseq/issues/1971#ref-issue-595576318
    ...
    def _generate(
        ...
        **kwargs
        ...
        a = model.forward_encoder(encoder_input) # a: [(token_out, sent_out, gnn_int, gnn_probs)]
        encoder_outs = [a[0][0]]
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            # add these 4 lines according to https://github.com/pytorch/fairseq/issues/1971#ref-issue-595576318
            if step == 0:
...
class EnsembleModel(torch.nn.Module):
    ...
    def z_decode_one(
        ...
        if self.incremental_states is not None:
            ...
            decoder_out = list(model.forward_decoder(tokens, encoder_out=encoder_out, z_encoder_out=z_encoder_out))
        decoder_out[0] = decoder_out[0][:, -1:, :]
        if temperature != 1.:
            decoder_out[0].div_(temperature)
        attn = decoder_out[1]
