...
class TranslationTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--prepend-bos', action='store_true', default=False,
                            help='prepend-bos works for XSum training')
        parser.add_argument('--lsr-reasoning', action='store_true', default=False,
                            help='use layer-shared reasoning pattern')
        parser.add_argument('--gnn_dp_rate', default=0.1, type=float, help='dp_rate_gnn')
        parser.add_argument('--not_sparse', action='store_true', default=False, help='if using sparse MT computation')
        parser.add_argument('--hop_layer', default=3, type=int, help='num of hop layer')
        # fmt: on
